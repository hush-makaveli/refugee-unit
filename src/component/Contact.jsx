            ...
            <div className="bg-[#f7f3f3] lg:h-[80vh] lg:flex pt-9">
                <div className="lg:w-[800px]">
                    <div className="lg:w-[90%] text-wrap lg:mx-auto lg:pt-5">
                        ...
                        <p className="text-[#575555] mt-3"><span className="font-bold">Head of Restoring family links Turkish Communications: International Federation Of Red Cross & Red Crescent Societies,</span> </p>
                        <p className="text-[#fd3b3b] font-bold">Dr Kubra Tastemir Divleli</p>
                        <p className="text-blue-500 font-bold">Head of Restoring family links Turkish Communications: International Federation Of Red Cross & Red Crescent Societies,
                            ISTANBUL. Office information. Address. Buyukdere Caddesi No: 209, Tekfen Tower, 4.Levent, Istanbul, Türkiye.
                            <p className=" text-blue-400"><span className="font-semibold"> Email: info@refugeerelo.com</span>  </p>
                            <p className="text-blue-400"><span className="font-semibold">Tel +44 1133 20 2866</span> </p>
                            <p className="text-blue-400"><span className="font-semibold">WhatsApp: +905 552 719 9936</span> </p>

                        </p>
                        <p className="text-[#575555]"><span className="font-bold"></span> </p>
                    </div>
                </div>
                <div className="w-[400px] mt-4 rounded bg-white h-[900px] space-y-5 p-4">
                    <h1 className="font-bold text-[50px] font-sans ">CONTACT <br /> DETAILS</h1>
                    <div className="flex">
                        <h3 className="font-bold flex ">RELOCATING OFFICER :</h3>
                        <p className="w-[350px] text-blue-500 font-bold flex flex-col"> <span className="text-[#fd3b3b] font-bold">Mrs Jennifer Lawrence.</span>
                           <span className="text-blue-500 font-bold"> ADDRESS CH-1201 Boynuyogun Antakya Turkey Ataç Sokak 1 No.32 Yenisehir Antakya ,</span> <span className="text-blue-400 font-semibold">Officer:Email : relocationunitoffice1@zohomail.com</span>
                            <span className="text-blue-400 font-semibold">Tel +90 531 500 09 46</span>
                            <span className="text-blue-400 font-semibold">WhatsApp : +90 531 500 09 46 </span>  </p>
                            <p className="text-blue-400"><span className="font-semibold"></span> </p>
                    </div> <hr />
                    <div className="flex">
                    ...
                    <div className="flex">
                        ...
                        <div className="pl-3 text-blue-400">
                            ...
                            <p>relocationofficerunit1@post.com</p>
                        </div>
                    </div> <hr />
                    <div className="flex">
                        <h3 className="font-bold">OFFICER  :</h3>
                        <p className="pl-3 text-[#fd3b3b] font-bold">Dr Sam Gomez6</p>
                    </div>
                    <div className="flex">
                        <h3 className="font-bold">ADDRESS</h3>
                        <p className="pl-3 flex flex-col text-blue-500 font-bold">Bursa, western Turkey Ataç-1 Sokak No: 32 Yenişehir 06420 Bursa, / TÜRKİYE Merkez District, Province, Bursa,Turkey P.M.B. 304,Bursa, 
                        <span className="text-blue-400 font-semibold">Tel: +61 4888 75 180</span> 
                        <span className="text-blue-400 font-semibold">WhatsApp : +90 5 XXXXXXXXX</span>  
                        <span className="text-blue-400 font-semibold">EMAIL : relocationofficerunit1@post.com</span> 
                         </p>
                    </div> <hr />
                </div>
            </div>
