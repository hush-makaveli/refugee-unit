...
function Header() {
  ...
  return (
    <div className='flex w-[100%] space-x-[00px] sm:justify-between sticky :top-0 z-[20]' id="header-bg">
        ...
        <nav className=' hidden lg:flex lg:h-[100px] lg:justify-between lg:w-[70%]' >
            <div className=' space-x-4 h-[50px] py-8 font-bold text-white p-[150px]'>
                <Link spy={true} smooth={true} offset={50} duration={500} className='hover:text-blue-600 hover:bg-slate-100 transition hover:rounded-lg hover:p-3 cursor-pointer' to="home">HOME</Link>
                <Link spy={true} smooth={true} offset={50} duration={500} className='hover:text-blue-600  hover:bg-slate-100 transition hover:rounded-lg hover:p-3 cursor-pointer' to="about">ABOUT</Link>
                <Link spy={true} smooth={true} offset={50} duration={500} className='hover:text-blue-600  hover:bg-slate-100 transition hover:rounded-lg hover:p-3 cursor-pointer' to="service">SERVICE</Link>
                <Link spy={true} smooth={true} offset={50} duration={500} className='hover:text-blue-600  hover:bg-slate-100 transition hover:rounded-lg hover:p-3 cursor-pointer' to="contact">CONTACT US</Link>
            </div>
        ...
        <div className={`fixed lg:hidden left-0 top-0 w-[300px] h-[500px] overflow-auto z-[30] rounded-r-xl bg-[#e8e8e8] transition-all duration-200 ${open ? "translate-x-[0px]" : "translate-x-[-500px]"}`}>
